...
export const ShareholdersDesktop = () => {
	return (
		<div className={css.root}>
			...
			>
				...
				/>
				<path d="M580 275L580 244" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 306L1053 275" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 565L1053 275" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 306L1084 306" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 390L1084 390" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 478L1084 478" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M1053 565L1084 565" stroke="#B9B9B9" stroke-linecap="round" />
				<path
					d="M873.999 306L873.999 244"
					stroke="#B9B9B9"
					stroke-linecap="round"
				/>
				<path d="M540 106L600 106" stroke="#B9B9B9" stroke-linecap="round" />
				<rect
					x="480"
					y="150"
					width="240"
				...
				<foreignObject x="614" y="308" width="117" height="80">
					<div className={cx(css.graphCustomContent, css.accent)}>Content_7</div>
				</foreignObject>
				<path
				...
				<path d="M58.9999 474L59 443" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M58.9998 733L59 389" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M59 474L90 474" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M59 558L90 558" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M59 646L90 646" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M59 733L90 733" stroke="#B9B9B9" stroke-linecap="round" />
				...
				<path d="M673 473L673 442" stroke="#B9B9B9" stroke-linecap="round" />
				<path
					d="M673.003 645L673.003 388"
					stroke="#B9B9B9"
					stroke-linecap="round"
				/>
				<path d="M673 473L704 473" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M673 557L704 557" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M673 645L704 645" stroke="#B9B9B9" stroke-linecap="round" />
				...
				<foreignObject x="704" y="444" width="133" height="59">
					<div className={cx(css.graphCustomContent, css.accent)}>Content_17</div>
				</foreignObject>
				...
				<path d="M475 473L475 442" stroke="#B9B9B9" stroke-linecap="round" />
				<path
					d="M475.002 557L475.002 389"
					stroke="#B9B9B9"
					stroke-linecap="round"
				/>
				<path d="M475 473L506 473" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M475 557L506 557" stroke="#B9B9B9" stroke-linecap="round" />
				...
				<path d="M275 474L275 443" stroke="#B9B9B9" stroke-linecap="round" />
				<path
					d="M275.002 897L275.002 391"
					stroke="#B9B9B9"
					stroke-linecap="round"
				/>
				<path d="M275 474L306 474" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M275 558L306 558" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M275 646L306 646" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M275 733L306 733" stroke="#B9B9B9" stroke-linecap="round" />
				...
				<path d="M275 810L306 810" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M275 897L306 897" stroke="#B9B9B9" stroke-linecap="round" />
				...
				<path d="M874 419L874 388" stroke="#B9B9B9" stroke-linecap="round" />
				<path
					d="M874.002 646L874.002 388"
					stroke="#B9B9B9"
					stroke-linecap="round"
				/>
				<path d="M874 474L905 474" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M874 558L905 558" stroke="#B9B9B9" stroke-linecap="round" />
				<path d="M874 646L905 646" stroke="#B9B9B9" stroke-linecap="round" />
