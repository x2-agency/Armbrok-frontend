...
export interface StructureTreeProps {
	...
	globalMarketsInvestment?: string;
	globalBrokerage?: string;
	globalPortfolioManagement?: string;
	globalProprietaryTrading?: string;
	globalResearchConsulting?: string;
	globalSales?: string;
	localMarketsInvestment?: string;
	localBrokerage?: string;
	localPortfolioManagement?: string;
	localInvestmentBanking?: string;
	localProprietaryTrading?: string;
	localResearchConsulting?: string;
	localSales?: string;
	operations?: string;
	depositaryCustodySettlements?: string;
	backOffice?: string;
	crm?: string;
	onboarding?: string;
	finance?: string;
	treasury?: string;
	accounting?: string;
	reportingBudgeting?: string;
	compliance?: string;
	humanResources?: string;
	marketingCorporateCommunications?: string;
...
export type PortfolioStructureProps = {
	...
	assetCurrencies?: AssetTypesSectionProps;
};
