...
import BackSVG from '@/public/assets/icons/arrow-without-stick-2.svg';
		...
		<div className={cx(css.root, className)}>
			<details className={css.details}>
				<summary className={css.summary}>
					<span className={css.summaryText}>{parser(t('button'))}</span>
					<BackSVG className={css.icon} />
				</summary>
			</details>
			<div className={css.accordionContent} role="definition">
				<div className={cx(css.accordionContentBody)}>
